...
client.on('ready', ()=>{
    client.user.setActivity("in love with divinity");
    })
...
client.on('message', message=>{
    ...
    else if(message.content.startsWith(`${prefix}triskelion`)){
        message.channel.send("cherry");
    }
    else if(message.content.startsWith(`%compliment`)){
        var complimenty = complimentsx[Math.floor(Math.random() * complimentsx.length)];
        message.channel.send(complimenty);
    }
